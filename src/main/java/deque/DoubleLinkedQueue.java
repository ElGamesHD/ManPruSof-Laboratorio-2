...
public interface DoubleLinkedQueue<T> {
     ...
     * <p>
     * More formally, returns {@code true} if and only if this deque contains at
     * least one
    ...
    /**
     * Removes the first occurrence of the specified element from this deque, if it
     * is present.
     *
    ...
    /**
     * Sorts this deque according to the order induced by the specified
     * {@code Comparator}.
     *
     * <h3>Implementation Requirements:</h3>
     * The implementation must use an in-place sorting algorithm; i.e., it is not
     * allowed to
